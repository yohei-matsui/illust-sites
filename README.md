...
| 上の平易な指示 + 顔の特徴を言葉でも明示(red curly hair, freckles, smiling)+ CFG 6 + ネガティブプロンプト | 成功。顔の再現度はさらに高いが、CFG を上げた分だけ服の色が濃く出た |
...
- 顔参照の特徴(髪型・髪色・そばかす・表情)を言葉でも書くと同一人物性が上がる。
- CFG を 4 → 6 に上げると指示に従いやすくなるが、色が濃くなるなど元画像からの色ずれが出やすい。
